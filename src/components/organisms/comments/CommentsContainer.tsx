import { ICommentsBase } from "@/interfaces/commentsDTO"
  ...
  return (
    <div className="flex flex-col gap-2 bg-slate-700 py-2 px-4 rounded-lg">
      <header className="flex justify-between">
        ...
        <button onClick={() => setIsOpen(s => !s)} className=" flex items-center justify-center h-7 w-7 rounded-lg bg-gray-900 hover:bg-gra-800 active:scale-90">
          {
            !isOpen ? (
